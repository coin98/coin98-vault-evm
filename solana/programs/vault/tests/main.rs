...
async fn test_create_vault() {
    ...
    let create_schedule_data = create_schedule_data_instruction(&payer_wallet.pubkey(), &vault_address, 2, 1, 0, merkle_root ,&c98_mint.pubkey(), &payer_c98_token_account, &cusd_mint.pubkey(), &payer_cusd_token_account);
